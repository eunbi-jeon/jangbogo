...
//	
//	// 대댓글 달기
//	public String createChildReply(@PathVariable("id")Long parentId, @Valid ReplyDto replyDto,
//			BindingResult bindingResult, Principal principal) {
//		
//		Board board = this.boardservice.getBoard(id);
//		Member member = this.memberservice.getMember(principal.getName());
//		Reply reply = replyservice.getReply(parentId);
//		
...
//	}
    ...
    @PostMapping("/reply/modify/{id}")
    	public String replyModify(@Valid ReplyDto replyDto, BindingResult bindingResult, @PathVariable("id") Long id, Principal principal) {
    		...
    		this.replyservice.modifyReply(id, replyDto.getContent());
